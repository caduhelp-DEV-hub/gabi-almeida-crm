...
export async function POST(request: Request) {
  try {
    ...
    const systemInstruction = `
      ...
      Você tem acesso ao seguinte contexto atual do Sistema:
      ...
      - Meta de Faturamento Mensal do Sistema: R$ 170.000 (atual em 82%, faltando R$ 27.420).
      ...
      2. Mantenha as respostas concisas, diretas ao ponto, com dicas práticas acionáveis de 2 a 4 frases, ideais para leitura rápida no painel lateral de um sistema clínico ocupado.
